...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Les frais sont calculés selon le quotient familial de votre foyer (revenus nets divisés par vos parts fiscales). Un entretien confidentiel avec la direction permet de définir ensemble votre contribution. L'objectif est que chaque famille puisse accéder à l'établissement quelle que soit sa situation financière.",
  },
  {
    question: "Le collège est-il ouvert aux élèves en difficulté scolaire ?",
    answer:
      "Oui. La Boussole accueille tous les profils, y compris les élèves en difficulté scolaire ou en situation de décrochage. Notre pédagogie différenciée et l'accompagnement individualisé permettent à chaque élève de progresser à son rythme, sans jugement.",
  },
  {
    question: "Les dons sont-ils défiscalisables ?",
    answer:
      "Oui. La Boussole est portée par une association reconnue d'intérêt général. Vos dons ouvrent droit à une réduction d'impôt de 66 % du montant versé, dans la limite de 20 % de votre revenu imposable.",
  },
  {
    question: "Quand et où ouvre le collège ?",
    answer:
      "Le Collège La Boussole est prévu d'ouvrir en septembre 2027 à Angers (Maine-et-Loire, 49). Les inscriptions pour la première promotion seront ouvertes prochainement. Contactez-nous pour être tenu informé.",
  },
];
