...
const SLIDES = [
  { label: "Salle de classe modulable", bg: "#C8B09A" },
  { label: "Espaces extérieurs", bg: "#B89A80" },
  { label: "Atelier pratique", bg: "#A8886C" },
  { label: "Réfectoire et vie commune", bg: "#987060" },
  { label: "Potager pédagogique", bg: "#886050" },
];
