...
const FALLBACK: FaqEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Les frais sont calculés selon le quotient familial de votre foyer, de 0 à 280 €/mois. L'objectif : que chaque famille puisse accéder à l'établissement quelle que soit sa situation financière.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Le Collège La Boussole est prévu d'ouvrir en septembre 2027 à Angers (Maine-et-Loire, 49). Les inscriptions pour la première promotion seront ouvertes prochainement.",
  },
];
