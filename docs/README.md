# 📘 Documentation – Projet Numérique Collège la boussole

Ce dossier `docs/` regroupe l’ensemble des documents de **conception, organisation et développement** du projet .
...
- **Type de projet** : Site web + back-office + Service de partage de fichiers
- **Architecture** :
- **Public cible** :
- **Objectif principal** : structurer et professionnaliser la présence numérique du collège
...
- Éviter les dérives fonctionnelles (_scope creep_)
